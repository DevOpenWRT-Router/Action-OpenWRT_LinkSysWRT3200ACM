...
###  Modify  argon  as the default theme, you can modify according to your favorite into the other (do not select the default theme theme will automatically have the effect of those changes to)
# sed -i 's/luci-theme-bootstrap/luci-theme-argon/g' feeds/luci/collections/luci/Makefile
